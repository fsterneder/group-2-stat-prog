...
=======
If we believe in this model than we could argue, since there is a positive slope, that it would be advantageous for a team to field older players. But although this model looks promising, it might suffer from a rather small sample size ($N=30$). In the next step we are going to expand our sample by looking at the data from the season 1985 to 2016.
>>>>>>> 36e60f7184ec27bebfcd338d98846ef9f60acd81
=======
If we believe in this model than we could argue, since there is a positive slope, that it would be advantageous for a team to field older players. But although this model looks promising, it might suffer from a rather small sample size ($N=30$). In the next step we are going to expand our sample by looking at the data from the season 1985 to 2016.
>>>>>>> a4703cb141a13aeb8c31e225b303239fbafa5e28
=======
If we believe in this model than we could argue, since there is a positive slope, that it would be advantageous for a team to field older players. But although this model looks promising, it might suffer from a rather small sample size ($N=30$). In the next step we are going to expand our sample by looking at the data from the season 1985 to 2016.
>>>>>>> a4703cb141a13aeb8c31e225b303239fbafa5e28
