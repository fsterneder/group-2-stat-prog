...
age_c_team %>% ggplot(aes(weightByG)) + geom_point(aes(y=Wprop)) + geom_line(aes(y=pred),color="#3068A1")
...
#TBD? Performance of individuals as they age 
...
sal_lg <- 
  ...
  labs(x = "Year", y = "Salary",
       title = "Salaries, grouped by league")
ggplotly(sal_lg)
...
sal_bb_stats_lg_mean <- 
  ...
  theme(axis.text.x = element_text(angle = 45, vjust = 0.5)) +
  scale_x_continuous(breaks = sal_bb_stats_lg$yearID) +
  labs(x = "Year", y = "Average salary (mean) in US$",
       title = "Average Salary per year and league")
ggplotly(sal_bb_stats_lg_mean)
...
sal_bb_stats_lg_all <- 
  ...
  theme(axis.text.x = element_text(angle = 45, vjust = 0.5)) +
  scale_x_continuous(breaks = sal_bb_stats_lg$yearID) +
  labs(x = "Year", y ="Salary (max, min, median, mean) in US$",
       title = "Maximum, minimum, median and mean Salary per year and league")
ggplotly(sal_bb_stats_lg_all)
...
ggplotly(sal_bb_stats_lg_range)
```
