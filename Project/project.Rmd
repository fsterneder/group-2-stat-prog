...
#getting salaries for only 2016
salaries16 <- Salaries %>%
  filter(yearID == 2016)

#getting the names of the top10 earning players in 2016
...
#getting the development of the top10 earning players
...
sal_mostp_pl_in16_plot <- ggplot(data = sal_mostp_pl_in16, mapping = aes(x = yearID, y = salary)) + 
  ...
  labs(x = "Year", y = "Salary per player in million US$", 
       title = "Salaries of the mostpaid baseball-players over time")
ggplotly(sal_mostp_pl_in16_plot)
```
