...
We find that the average active professional baseball player , in the season of `r age_year`, was born `r mean(age_c_players$birthDate)` and was therefore `r floor(age_calc(mean(age_c_players$birthDate),ymd(age_const)))` years old. 
...
```{r results="asis"}
stargazer(age_team_perf_mod, align=T, type='html')
```
